...
export const generateEventCheck = createAsyncThunk(
    'works/generateEventCheck',
    async ({ workId, eventId }, { rejectWithValue }) =>
        wrapper(generateAppUserEventCheck, rejectWithValue)(workId, eventId)
);
