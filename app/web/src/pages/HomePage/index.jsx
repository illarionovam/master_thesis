        ...
        <main aria-labelledby={titleId} className="page centered">
            ...
            <section className={styles.grid} aria-label="Quick start">
                ...
                <article className={styles.card}>
                    ...
                    <Link to="/characters" className={styles.cardLink}>
                        Go to characters →
                    </Link>
                </article>

                <article className={styles.card}>
                    <h2 className={styles.cardTitle}>Locations & Events</h2>
                    <p className={styles.cardText}>
                    ...
                    <Link to="/locations" className={styles.cardLink}>
                        Go to locations →
                    </Link>
                </article>
            </section>
